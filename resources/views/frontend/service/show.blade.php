...
{{-- @dd($service); --}}
    <div id="product-detail">
        <div class="container">
            ...
            <div class="row product py-5" style="padding-bottom: 0rem !important;">
{{--                <div class="col-12 col-lg-5 milk-two">--}}
{{--                    <div class="bg-img text-center prod-img" id="zoom-img">--}}
...
{{--                </div>--}}
                <div class="col-12 col-lg-5 milk-two">
                    @php
                        $images = json_decode($service->multi_img);

                    @endphp
                    <div class="bg-img text-center prod-img" id="zoom-img">
                        <img class="product-image" src="{{ Voyager::image($service->image) }}" alt="{{ $service->translate()->title }}">
                    </div>
                    <div class="gallery pt-4">
                        <div class="product-gallery d-flex pt-4 pt-lg-0">
                            <div class="owl-carousel owl-theme" id="galler-catalog">
                                <div class="text-center gallery-img py-2">
                                    <img src="{{ Voyager::image($service->image) }}" name-img="{{ Voyager::image($service->image) }}" alt="{{ $service->translate()->title }}">
                                </div>
                                @foreach($images as $image)
                                    <div class="text-center gallery-img py-2">
                                        <img src="{{ Voyager::image($image) }}" name-img="{{ Voyager::image($image) }}" alt="{{ $service->title }}">
                                    </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-7 pt-5 pt-lg-0">
                    <div class="milk-two">
                        <h1 style="font-family: Roboto, sans-serif;" class="font-weight-bold m-0 pb-2 product-name" id="product-name">{{ $service->translate()->title }}</h1>
                        <p class=" pb-2 m-0 font-text title-pro">{{ $service->translate()->desc }}</p>
                        <div class="ratings" style="margin-top: 20px; margin-bottom: 20px">
                            <span class="star"></span>
                            <span class="star"></span>
                            <span class="star"></span>
                            <span class="star"></span>
                            <span class="star"></span>
                            <a href="javascript:void(0);" id="myLink"><p style="margin-bottom: -0.25rem; margin-left: 10px">{{__('See reviews from 515 customers who have purchased')}}</p></a>
                            <script>
                                document.getElementById('myLink').addEventListener('click', function() {
                                    const targetSection = document.getElementById('mySection');
                                    if (targetSection) {
                    ...
                    @if( $service->promotional != "" )
                        <div class="pro-border py-4 py-lg-2 py-lg-4">
                            <p class="mb-0" style="margin-bottom: 10px">
                                <span class="pr-2">{{__('Promotional price')}}:</span>
                                <b class="text-red" id="price">{{number_format($service->promotional)}}VND</b>
                            </p>
                            <p class="mb-0">
                                <span class="pr-2">{{__('Listed price')}}:</span>
                                <b id="price" style="text-decoration: line-through;">{{number_format($service->price)}}VND</b>
                            </p>
                        </div>
                    @else
                        <div class="pro-border py-4 py-lg-2 py-lg-4">
                            ...
                            <p class="mb-0">
                                <span class="pr-2">{{__('Listed price')}}:</span>
                                <b id="price">{{number_format($service->price)}}VND</b>
                            </p>
                        </div>
                    @endif


                    <div class="product-qty pro-border py-4 py-lg-2 py-lg-4">
                        <div class="d-flex align-items-center">
                            <p class="mb-0 pr-5">{{__('Number')}} </p>
                            <button type="button" class="px-3 decrease">-</button>
                            <input type="number" data-product-id="2" min="1" step="1" value="1" 
                                class="qty text-center"  name="qty">
                           
                            <button type="button" class="px-3 increase">+</button>
                        </div>
                    </div>
                    
                    <div class="col-12 col-lg-7 text-center mb-3 add-to-cart-section" style="text-align: left!important;">
                        <button type="submit" class="py-3 py-md-2 add-to-cart">
                             {{__('Add to cart')}}
                        </button>
                    </div>
                </div>
            ...
            <div class="row product-descriptions py-4 py-lg-5" style="padding-top: 0rem !important">
                <div class="col-12">
                    <div class="product-description-border">
                        <ul class="nav nav-tabs nav-fill d-lg-flex align-items-center justify-content-start m-0 p-0 pb-3"
                            id="nav-tab" role="tablist">
                        </ul>
                    </div>
                </div>
                <div class="col-12">
                    <div class="row pt-5 content-with-sidebar">
                        <div class="col-12 col-lg-8 product-tab-details">
                            <div class="tab-content">
                                <div class="content tab-pane fade show active" id="highlights" role="tabpanel"
                                    aria-labelledby="highlights-tab">
                                    <div>
                                        <div class="subject" id="accordion">
                                            <div class="banner-baby pb-4" id="problem-baby" style="background-color: #ffd44c;padding-bottom: 0.2rem !important;">
                                                <h2 class="title" style="padding: 10px 20px 0px 20px;font-weight: 500;color: #212529;margin-bottom: 0;">{{__('PRODUCT DESCRIPTION')}}</h2>
                                            </div>
                                            <p>{!! $service->translate()->body !!}</p>
                                ...
                                <div class="content tab-pane fade" id="ingredient" role="tabpanel"
                                    aria-labelledby="ingredient-tab">
                                    <p>
                                    </p>
                                </div>
                                <div class="content tab-pane fade" id="manual" role="tabpanel"
                                    aria-labelledby="manual-tab">
                                    <p></p>
                                </div>
                                <div class="content tab-pane fade" id="comments" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div id="sticky-slidebar" class="pb-4">
                                        <div class="quangcao pb-4" style="background-color: #ffd44c;padding-bottom: 0.2rem !important;">
                                            <h2 class="title" style="padding: 10px 20px 0px 20px;font-weight: 500;color: #212529;margin-bottom: 0;">{{__('Other products')}}</h2>
                                        </div>
                                        <div>
    ...
    <section id="mySection" class="product-single__reviews">
        <div class="container">
            <div class="product-reviews product-single--reviews">
                <h2 class="heading">{{__('REVIEWS FROM CUSTOMERS BUYING')}}</h2>
                <div class="reviews-infomations">
                    <div class="reviews-infomations__grid">
                            <div class="reviews-infomations__ratings">
                        <div class="wrapper">
            ...
            <div class="reviews-infomations__line">
                    <div class="item">
            <div class="ratings">
                <span class="star"></span>
                <span class="star"></span>
            ...
            <div class="line-percent">
                <span style="width: 92.670157068063%; height: 10px"></span>
            </div>
            <span class="label">(177)</span>
        </div>
        <div class="item">
            <div class="ratings">
                <span class="star"></span>
            ...
            <div class="line-percent">
                <span style="width: 5.2356020942408%; height: 10px"></span>
            </div>
        ...
        <div class="item">
            ...
            <div class="line-percent">
                <span style="width: 1.5706806282723%; height: 10px"></span>
            </div>
        ...
        <div class="item">
            ...
            <div class="line-percent">
                <span style="width: 0.52356020942408%; height: 10px"></span>
            </div>
            <span class="label">(1)</span>
        </div>
    </div>
    
    <div class="reviews-infomations__actions">
        <a href="" class="reviews-infomations__button write-reviews" style="background-color: #fafbf7;">
            <span class="label">
    ...
    <div class="reviews-content">
        @if (count($service->questions) > 0)
            @foreach($service->questions as $question )
                ...
                <div class="item">
                    <div class="avatar">
                        <img class=" ls-is-cached lazyloaded" data-src="{{ Voyager::image($question->image) }}" alt="t*****8" src="{{ Voyager::image($question->image) }}">
                    </div>
                    <div class="content">
                        <span class="name">{{$question->name}}<img class=" ls-is-cached lazyloaded" data-src="https://assets.comem.vn/images/checked3.png" alt="checked-da-mua-hang-co-mem" title="checked-da-mua-hang-co-mem" style="width: 18px" src="https://assets.comem.vn/images/checked3.png"> <span style="font-weight: normal; font-size: 13px">Đã mua hàng</span></span>
                        <div class="ratings">
                            <span class="star"></span>
                            <span class="star"></span>
                            <span class="star"></span>
                        ...
                        <div class="gallery reviews--gallery"></div>
                        @if(!is_null($question->answer))
                            <div class="feedback">
                                <span class="name">{{__('Response from admin')}}</span>
                                <p>{{$question->answer}}</p>
                            </div>
                        @else
