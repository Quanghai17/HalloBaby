...
class AdminOrderController extends \TCG\Voyager\Http\Controllers\Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $orderDetail= \App\Bookdetail::where('id_book', $dataTypeContent->id)->get();
        $view = 'admin.order-detail';

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'orderDetail'));
    }
    ...
    {
        $order= \App\Book::find($request->order_id);
        if ($order){
